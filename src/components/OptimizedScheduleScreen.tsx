...
export function OptimizedScheduleScreen({ places, tripData, onClose, onSave }: OptimizedScheduleScreenProps) {
    ...
    return (
        <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'spring', damping: 25, stiffness: 200 }} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#f8f9fa', zIndex: 4000, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
